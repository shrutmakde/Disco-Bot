...
async def on_message(message):
    ...
    if message.content.startswith("Who is my creator?"):
        await message.channel.send("Shrut made me in 2020. I initially started out as a bot for jokes but now he works on me part time.")
...
async def on_member_join(member):
    ...
    await member.dm_channel.send(f'Hi {member.name}, welcome to my Discord server! I am a bot made by Shrut entirely in python. Nice to meet you!')
